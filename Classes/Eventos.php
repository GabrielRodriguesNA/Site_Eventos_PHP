...
class Eventos {
    ...
    public static function getById($id) {
        ...
        $stmt->close();
        $conn->close();
        return $event ? new Eventos($event['id'], $event['title'], $event['description'], $event['date'], $event['time'], $event['location'], $event['category_id'], $event['price'], $event['images']) : null;
    }
    ...
    public static function getAll() {
        ...
        while ($event = $result->fetch_assoc()) {
            $events[] = new Eventos($event['id'], $event['title'], $event['description'], $event['date'], $event['time'], $event['location'], $event['category_id'], $event['price'], $event['images']);
        }
        $stmt->close();
        $conn->close();
        return $events;
